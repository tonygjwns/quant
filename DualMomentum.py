# -*- coding: utf-8 -*-
"""
Created on Mon Dec 27 15:59:38 2021
...
class DualMomentum:
    ...
    def get_rltv_momentum(self, start_date, end_date, stock_count):
        ...
        connection = pymysql.connect(host='localhost', port=3306, 
            db='tony', user='root', passwd='tonygjwns1@', autocommit=True,charset='utf8')
    ...
    def get_abs_momentum(self, rltv_momentum, start_date, end_date):
        ...
        connection = pymysql.connect(host='localhost', port=3306, 
            db='tony', user='root', passwd='tonygjwns1@', autocommit=True)
        cursor = connection.cursor()
